...
glColor3f(1,0,0);
drawstring(350.0,700.0,0.0,"MAGALORE INSTITUTE OF TECHNOLOGY & ENGINEERING");
glColor3f(0.7,0,1);
...
glColor3f(1,1,1);
drawstring(100,300,0.0,"name:\tSPANDANA   usn:\t4MT19CS160");
glColor3f(1,1,1);
drawstring(100,240,0.0,"name:\tSHREYAS M   usn:\t4MT20CS401");
glColor3f(1,0.5,0);
drawstring(980,400,0.0,"GUIDES:");
glColor3f(1,1,1);
drawstring(930,300,0.0,"name:\tMs.Aishwarya M Bhat");
glColor3f(1,1,1);
drawstring(930,240,0.0,"  name:\tMs.Sunitha");
glColor3f(1,0.1,1);
