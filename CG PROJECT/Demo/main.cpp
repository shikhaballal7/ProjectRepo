...
glColor3f(1,0,0);
drawstring(350.0,700.0,0.0,"MANGALORE INSTITUTE OF TECHNOLOGY & ENGINEERING");
glColor3f(0.7,0,1);
drawstring(350,650,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
glColor3f(1,0.5,0);
drawstring(350,600,0.0,"A MINI PROJECT ON COMPUTER GRAPHICS LABORATORY");
glColor3f(1,0,0);
drawstring(350,500,0.0,"GRAPHICAL REPRESENTATION OF TRAFFIC SIGNALS");
glColor3f(1,0.5,0);
drawstring(200,400,0.0,"BY:");
glColor3f(1,1,1);
drawstring(100,300,0.0,"Name:\tShamitha Shetty   usn:\t4MT20CS145");
glColor3f(1,1,1);
drawstring(100,240,0.0,"Name:\tShikha Ballal    usn:\t4MT20CS150");
glColor3f(1,0.5,0);
drawstring(980,400,0.0,"GUIDE:");
glColor3f(1,1,1);
drawstring(930,300,0.0,"Name:\tMr.Shivaraj B G");
glColor3f(1,1,1);
...
switch(key)
{
	...
	case 'h':flag=1;mydisplay();
		break;
	case 'u':flag=1; void uturncar(int x,int y);
	      break;
	default:break;
}
